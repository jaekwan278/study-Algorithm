package programmers.intro.loginSuccess;
...
public class LoginSuccess {
    ...
    public String solution(String[] id_pw, String[][] db) {
        String[] status = {"login", "fail", "wrong pw"};
    ...
    public String solution2(String[] id_pw, String[][] db) {
        ...
        return idExists ? "wrong pw" : "fail";
    }

    public static void main(String[] args) {
        LoginSuccess task = new LoginSuccess();

        String[][] db = {{"rardss", "123"}, {"yyoom", "1234"}, {"meosseugi", "1234"}};
        String[] id_pw = {"yyoom", "15789"};

        System.out.println(task.solution(id_pw, db));
    }
}
